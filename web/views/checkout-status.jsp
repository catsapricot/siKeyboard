...
<head>
    ...
    <title>siKeyboard - Checkout Status</title>
...
<body>
    ...
    <main class="main-content">
        <div class="confirmation-container">
            ...
            <p>Terima kasih telah berbelanja. Anda akan diarahkan ke halaman utama.</p>
        </div>
    </main>
    ...
    <script>
        ...
        function selectPayment(method) {
            ...
            const methodIndex = ['bank', 'gopay', 'pulsa', 'credit'].indexOf(method);
            
            if (methodIndex !== -1) {
                const selectedRadio = paymentOptions[methodIndex].querySelector('.radio-btn');;
                selectedPayment = method;
                
                showNotification(`${method.charAt(0).toUpperCase() + method.slice(1)} payment method selected`);
            }
        }
        setTimeout(() => {
